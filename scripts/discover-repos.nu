...
# Discover public repositories in the fusabi-lang organization
...
#   - GITHUB_ORG: GitHub organization name (default: fusabi-lang)
#
# Output:
#   JSON array of repository objects with name, url, docs_path

def main [
    --org: string = "fusabi-lang"  # GitHub organization name
