...
Documentation for the ($project) project from fusabi-lang.
...
def generate_projects_index [source: string, projects: list] {
    ...
    let lines = [
        "---"
        "title: Projects"
        "description: Overview of all fusabi-lang projects"
        "tags: [projects, overview]"
        "---"
        ""
        "# Fusabi Lang Projects"
        ""
        ...
        "---"
        ""
        "*For more information about fusabi-lang, visit the [GitHub organization](https://github.com/fusabi-lang).*"
    ]
