# Claude Code Configuration - Fusabi Lang Documentation Hub

## Project Overview

This repository serves dual purposes:
1. **Obsidian Vault**: For interactive note-taking and knowledge management
2. **Public Documentation Site**: Aggregates and publishes documentation from all fusabi-lang public repositories
...
### Aggregation System
- **Git Submodules**: Link to `/docs` directories from fusabi-lang repositories
...
│   │   ├── project-1/        # Submodule: fusabi-lang/project-1/docs
│   │   ├── project-2/        # Submodule: fusabi-lang/project-2/docs
│   │   └── ...
...
- Nushell script queries GitHub API for fusabi-lang org repositories
...
### discover-repos.nu
Queries GitHub API to find all public fusabi-lang repositories, filters against ignorelist, outputs list of repositories with docs directories.
...
- fusabi-lang GitHub Organization
...
**Note**: This repository is public and only aggregates from public repositories within the fusabi-lang organization. Ensure no sensitive information is committed.
